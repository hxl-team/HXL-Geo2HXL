...
//The sample configuration below is for Foolandia Pop Places
//For convenience, paste the CSV header row here:
//WKT,Name,Pcode,Admin2Pcod,Altname,Class

$countryName = "Foolandia" ; //Only used when processing Admin 0, otherwise ignored.
$countryPcode = "FOO" ; //Only used when processing Admin 0, otherwise ignored.

$country_iso3 = "foo" ; //ISO 3 letter code for the country, lower case.  This becomes part of the URI for the features generated by the script.
...
$level_n_minus_one_pcode_element = 3 ;  //which column contains the pcode for the admin unit one level above the level that is being converted. This is ignored if $n = 0 (See below).
...
$popPlaceClass_element = 5 ; //for populated places, which column contains the class number.  Note that these must be numbers with the lower numbers representing higher status in the hierarchy.  See http://hxl.humanitarianresponse.info for details.  Ignored if $n != 999.
...
$pplClass['_1stOrder'] = 'Admin0Capital' ;
$pplClass['_2ndOrder'] = 'Admin1Capital' ;
$pplClass['_3rdOrder'] = 'Admin2Capital' ;
$pplClass['_4thOrder'] = 'Small' ;
...
$file_to_process = "PopPlaces.csv" ;
$output_file_name = "FOO_ppl_v1.ttl" ;

//Metadata items
$dcdate = "2012-11-15T11:16:00.0Z" ; //the date the file is created
$validon = "2012-11-15" ;  //Beginning date for which this dataset is the valid one.  This value is applied to the data container (i.e. named graph) which holds the data.  The end of the period of validity for this dataset is the first later ValidOn for a given feature.
