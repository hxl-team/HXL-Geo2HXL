...
$level_n_pcode_element = 4 ; //which column contains the pcode for the level that is being converted.  First column = 0. Ignored if $n = 0. See below.
$level_n_minus_one_pcode_element = 2 ;  //which column contains the pcode for the admin unit one level above the level that is being converted. This is ignored if $n = 0 or $n = 1 (See below).
...
$file_to_process = "/Users/carsten/Desktop/Pakistan/Pak_adm2_pco_20110324.csv" ;
$output_file_name = "/Users/carsten/Desktop/Pakistan/Pak_adm2_pco_20110324.ttl" ;
