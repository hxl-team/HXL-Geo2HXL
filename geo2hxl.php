...
//Burkina Faso Admin 1 configuration
//CSV header row: WKT,CNTRY_NAME,CNTRY_CODE,ADM1_NAME,ADM1_COD_1
$geom_element = 0 ; //which column contains the WKT geometry. First column = 0.
$level_n_pcode_element = 4 ; //which column contains the pcode for the level that is being converted
$level_n_minus_one_pcode_element = "2" ;  //which column contains the pcode for the admin unit one level above the level that is being converted. This is ignored if $n = 0 (See below).
$n = 1 ; //base admin level being processed. Set to 0 if you are processing the national boundary.
$featureName_element = 3 ; //which column contains the feature name
$featureRefName_element = 3 ; //which column contains the feature ref name 
...
$file_to_process = "bfa_admbnda_adm1_1m_salb.csv" ;
$output_file_name = "bfa_admbnda_adm1_1m_salb.ttl" ;
//Metadata items
