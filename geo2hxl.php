...
$level_n_pcode_element = 10 ; //which column contains the pcode for the level that is being converted.  First column = 0. Ignored if $n = 0. See below.
$level_n_minus_one_pcode_element = 8 ;  //which column contains the pcode for the admin unit one level above the level that is being converted. This is ignored if $n = 0 or $n = 1 (See below).
$n = 5 ; //base admin level being processed. Set to 0 if you are processing the national boundary. Set to 999 if you are processing the populated places layer.  Otherwise set to the admin level you are processing: 1, 2, 3, etc.
...
$file_to_process = "/Users/carsten/Desktop/Pakistan/Pak_adm5_floodAffected_pco_20110324.csv" ;
$output_file_name = "/Users/carsten/Desktop/Pakistan/Pak_adm5_floodAffected_pco_20110324.ttl" ;
