...
$level_n_pcode_element = 6 ; //which column contains the pcode for the level that is being converted.  First column = 0. Ignored if $n = 0. See below.
$level_n_minus_one_pcode_element = 4 ;  //which column contains the pcode for the admin unit one level above the level that is being converted. This is ignored if $n = 0 or $n = 1 (See below).
$n = 3 ; //base admin level being processed. Set to 0 if you are processing the national boundary. Set to 999 if you are processing the populated places layer.  Otherwise set to the admin level you are processing: 1, 2, 3, etc.
$featureName_element = 5 ; //which column contains the feature name. Ignored if $n = 0.
$featureRefName_element = 5 ; //which column contains the feature ref name.  Note that the script will automatically change accented characters if found, so this can be the same column as the $featureName_element. Ignored if $n = 0.
...
$file_to_process = "/Users/carsten/Desktop/Pakistan/Pak_adm3_pco_20110324.csv" ;
$output_file_name = "/Users/carsten/Desktop/Pakistan/Pak_adm3_pco_20110324.ttl" ;
