...
$level_n_pcode_element = 999 ; //which column contains the pcode for the level that is being converted.  First column = 0. Ignored if $n = 0 (see below). Set to 999 if the data to convert does not have a p-code. 
$level_n_minus_one_pcode_element = 37 ;  //which column contains the pcode for the admin unit one level above the level that is being converted. This is ignored if $n = 0 or $n = 1 (See below).
...
$featureName_element = 25 ; //which column contains the feature name. Ignored if $n = 0.
$featureRefName_element = 25 ; //which column contains the feature ref name.  Note that the script will automatically change accented characters if found, so this can be the same column as the $featureName_element. Ignored if $n = 0.
...
$file_to_process  = "/Users/carsten/Desktop/CODs/Pakistan/PAK_Settlements_NGA_Admin_Bndry_Attributes_20111006.csv" ;
$output_file_name = "/Users/carsten/Desktop/CODs/Pakistan/PAK_Settlements_NGA_Admin_Bndry_Attributes_20111006.ttl" ;
